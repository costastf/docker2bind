...
# -*- coding: utf-8 -*-
#
# docker2bind documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'), 
                   os.path.join(project_root, '''docker2bind''')])
...
version = docker2bind.__version__
# The full version, including alpha/beta/rc tags.
release = docker2bind.__version__
...
htmlhelp_basename = '''docker2binddoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''docker2bind.tex''',
     u'''docker2bind Documentation''',
